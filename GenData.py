...
def main():
    imgTrainingNumbers = cv2.imread("training_chars.png")  # Read in the training numbers image
    ...
    intValidChars = [ord(str(i)) for i in range(10)] + [ord('A'), ord('B'), ord('C'), ord('D'), ord('E'), ord('F'), ord('G'), ord('H'), ord('I'), ord('J'),
